...
public class Example {
    ...
    private static boolean isArticle(String string) {
        return string.equals("a") || string.equals("an") || string.equals("the");
    }
    
    private static void appendWords(StringBuilder stringBuilder, Formatter formatter, List<String> words, int start, int end) {
    ...
    private static String sortableString(String string) {
    ...
    public static void getSortableDescription(String stringDescription) {
        System.out.println(" Input: " + stringDescription);
        System.out.println("Ouptut: " + sortableString(stringDescription));
    }
}
