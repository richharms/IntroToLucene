...
public class Example {
    ...
    public static void writeIndex(Directory directory, Analyzer analyzer) 
        ...
        try (IndexWriter indexWriter = new IndexWriter(directory, indexWriterConfig)) {
            ...
            addDocument(indexWriter, "4", "B00YT8SCSG", "Insidious: Chapter 1 (Blu-ray + Ultraviolet)"); // **
            addDocument(indexWriter, "5", "B00VGQKBQ0", "The Walking Dead: Season 5 [Blu-ray]");
            addDocument(indexWriter, "6", "B00YT8SCSH", "Insidious: Chapter 10 (Blu-ray + Ultraviolet)"); // **
            addDocument(indexWriter, "7", "B00YT8SCSJ", "Insidious: Chapter 2 (Blu-ray + Ultraviolet)"); // **
        }
    }
